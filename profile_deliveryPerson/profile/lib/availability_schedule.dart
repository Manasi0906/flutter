...
class _AvailabilitySchedulePageState extends State<AvailabilitySchedulePage> {
  ...
  Future<void> _selectTime(BuildContext context, bool isStartTime) async {
    if (isDayOff) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cannot set time on Day Off')),
      );
    ...
    if (pickedTime != null) {
      setState(() {
        ...
        selectedTime = "${selectedStartTime.format(context)} - ${selectedEndTime.format(context)}";
      });
    }
  }
  ...
  Future<void> _selectDate(BuildContext context) async {
    if (isDayOff) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cannot set date on Day Off')),
      );
  ...
  void _addSchedule() {
    if (isDayOff) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cannot add schedule on Day Off')),
      );
  ...
  void _toggleDayOff() {
    setState(() {
      ...
      if (isDayOff) {
        ...
        selectedEndTime = TimeOfDay(hour: 17, minute: 0);
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      elevation: 4,
                      color: schedule['status'] == 'Available' ? Colors.red.shade100 : Colors.white,
                      child: ListTile(
