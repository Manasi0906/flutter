...
class _WalletPageState extends State<WalletPage> {
  ...
  Widget build(BuildContext context) {
    ...
    int calculateTotal(Map<String, List<Map<String, String>>> data) {
      return data.values
          .expand((month) => month)
          .fold(0, (sum, entry) => sum + int.parse(entry['amount']!.replaceAll('₹', '')));
    }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wallet',textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 28,
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  int monthlyTotal = entries.fold(0, (sum, entry) => sum + int.parse(entry['amount']!.replaceAll('₹', '')));
